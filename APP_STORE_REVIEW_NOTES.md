...
`pubspec.yaml` indica `1.0.86+94`. De ahí sale **solo el nombre de versión**
...
El registro de versión de App Store Connect tiene que llamarse **1.0.86** para
que acepte esta build: Apple revisó «1.0 (61)», así que si el registro sigue
siendo `1.0` hay que crear el de `1.0.86` o cambiar el nombre de versión aquí.
