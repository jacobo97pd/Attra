...
class ProfilePromptCatalog {
  ...
  static const List<CatalogPrompt> all = <CatalogPrompt>[
    ...
    CatalogPrompt(
        'ice_05', 'ice', 'Si solo pudieras preguntarme una cosa, pregunta…'),
    ...
    CatalogPrompt(
        'ice_10', 'ice', 'Algo que parece pequeño pero me conquista es…'),
    // --- Citas y planes ---
    ...
    // --- Personalidad ---
    CatalogPrompt(
        'pers_01', 'personality', 'La mejor forma de describirme sería…'),
    ...
    CatalogPrompt(
        'pers_05', 'personality', 'Mi lado más competitivo sale cuando…'),
    CatalogPrompt(
        'pers_06', 'personality', 'La gente se sorprende cuando descubre que…'),
    ...
    CatalogPrompt(
        'humor_05', 'humor', 'Si mi vida fuera una película se llamaría…'),
    CatalogPrompt('humor_06', 'humor', 'Mi playlist me delata porque…'),
    CatalogPrompt(
        'humor_07', 'humor', 'Mi excusa favorita para salir de casa es…'),
    ...
    CatalogPrompt(
        'taste_03', 'tastes', 'Una película que puedo ver mil veces es…'),
    ...
    CatalogPrompt(
        'values_05', 'values', 'Me siento atraído/a por personas que…'),
    ...
    CatalogPrompt(
        'values_08', 'values', 'Lo que más cuido en una relación es…'),
    ...
    CatalogPrompt(
        'deep_06', 'deep', 'Una conversación que me encanta tener es…'),
    ...
    CatalogPrompt(
        'day_04', 'everyday', 'La rutina en pareja que me encantaría es…'),
    CatalogPrompt('day_05', 'everyday', 'Sé que hay confianza cuando podemos…'),
    CatalogPrompt('day_06', 'everyday',
        'Mi forma de cuidar a alguien en el día a día es…'),
    CatalogPrompt(
        'day_07', 'everyday', 'Lo que hace especial un día normal es…'),
    CatalogPrompt('day_08', 'everyday', 'Discutiríamos en broma por…'),
    CatalogPrompt('day_09', 'everyday', 'Mi domingo perfecto en pareja es…'),
    CatalogPrompt(
        'day_10', 'everyday', 'Un detalle cotidiano que me derrite es…'),
    CatalogPrompt('day_11', 'everyday', 'Compartiría sin pensarlo mi…'),
    CatalogPrompt('day_12', 'everyday',
        'La canción que pondría mientras cocinamos sería…'),

    // --- Romántico (intención de pareja, ternura, futuro) ---
    CatalogPrompt(
        'rom_01', 'romantic', 'Lo que más ilusión me hace de enamorarme es…'),
    CatalogPrompt(
        'rom_02', 'romantic', 'Sé que me gusta alguien de verdad cuando…'),
    ...
    CatalogPrompt(
        'rom_06', 'romantic', 'Un “para siempre” conmigo se parece a…'),
    ...
    CatalogPrompt(
        'rom_11', 'romantic', 'Mi idea de una noche perfecta juntos es…'),
    CatalogPrompt(
        'rom_12', 'romantic', 'Lo primero que querría hacer contigo es…'),
    ...
    CatalogPrompt('vuln_04', 'vulnerability',
        'Una cosa que necesito en una relación es…'),
    CatalogPrompt(
        'vuln_05', 'vulnerability', 'Me da un poco de respeto, pero quiero…'),
    CatalogPrompt('vuln_06', 'vulnerability', 'Cuando confío en alguien, yo…'),
    CatalogPrompt('vuln_07', 'vulnerability',
        'Lo que me gustaría que entendieran de mí es…'),
    CatalogPrompt('vuln_08', 'vulnerability',
        'Un día difícil mejora muchísimo si alguien…'),
    CatalogPrompt('vuln_09', 'vulnerability', 'Me siento yo mismo/a cuando…'),
    CatalogPrompt(
        'vuln_10', 'vulnerability', 'Me cuesta pedirlo, pero agradezco mucho…'),
    CatalogPrompt(
        'vuln_11', 'vulnerability', 'Lo que de verdad estoy buscando es…'),
    CatalogPrompt(
        'vuln_12', 'vulnerability', 'Estoy aprendiendo a abrirme sobre…'),

    // --- Valores y relación (refuerzo romántico) ---
    CatalogPrompt(
        'values_11', 'values', 'La base de una buena relación para mí es…'),
    CatalogPrompt(
        'values_12', 'values', 'Quiero a mi lado a alguien que también…'),
    CatalogPrompt('values_13', 'values', 'Discrepar bien para mí significa…'),
    CatalogPrompt(
        'values_14', 'values', 'El equipo perfecto en pareja sería el que…'),

    // --- Citas y planes (más planes a futuro) ---
    CatalogPrompt(
        'dates_11', 'dates', 'El viaje que me encantaría hacer en pareja es…'),
    CatalogPrompt(
        'dates_12', 'dates', 'Una tradición de pareja que crearía es…'),
  ];
